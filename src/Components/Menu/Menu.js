  ...
  return (
    <div className="menu">
      ...
      <ul>
        ...
        <ul>
          <li><a className="submenu" href="https://sourceforge.net/projects/stochsd/files/" target="_blank">Download StochSD</a></li>
          <li><a className="submenu" href="https://github.com/stochsd/stochsd/" target="_blank">Download Source code</a></li>
          <li><a className="submenu" href="https://stochsd.sourceforge.io/software/" target="_blank">Try online</a></li>
        </ul>
        </li>
